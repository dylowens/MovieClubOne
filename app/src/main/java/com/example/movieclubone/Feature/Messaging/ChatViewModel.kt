package com.example.movieclubone.Feature.Messaging
...
class ChatViewModel : ViewModel() {
    ...
    private fun listenForMessages() {
        Log.d("com.example.movieclubone.Feature.Messaging.ChatViewModel", "Attempting to listen for messages")
        ...
        messagesListenerRegistration = db.collection("messages")
            ...
            .addSnapshotListener { snapshot, e ->
                if (e != null) {
                    Log.e("com.example.movieclubone.Feature.Messaging.ChatViewModel", "Listen failed.", e)
    ...
    fun deleteMessage(context: Context, id: String) {
        ...
        Log.d("com.example.movieclubone.Feature.Messaging.ChatViewModel", "Attempting to delete message with ID: $id")
        viewModelScope.launch(Dispatchers.IO) {
            try {
                ...
                if(message.documents.isEmpty()) {
                    ...
                    Log.d("com.example.movieclubone.Feature.Messaging.ChatViewModel", "Message deleted successfully")
                }
            } catch (e: Exception) {
                Log.e("com.example.movieclubone.Feature.Messaging.ChatViewModel", "Error deleting message: ", e)
            }
        }
    }
